...
dir1 <- "/home/krax7/ClasesDevf/IDS/5-6-EDA/ggplot/Out" # Base de datos
# dir1 <- "~/nombre_repo/databases" # Base de datos (Solo Docker)
dir2 <- "/home/krax7/ClasesDevf/IDS/5-6-EDA/ggplot/Graphs" # Gráficas
...
gr <- ggplot(tempo, aes(x=des12a17, y=des26a40, color=sexo)) +
  ...
  labs(title="Porcentaje de desaparecidos por sexo \n 12 a 17 años vs 26 a 40 años",
       x="% de desaparecidos 12 a 17 años", y="% de desaparecidos 25 a 40 años", color="Sexo") +
  theme_bw()
